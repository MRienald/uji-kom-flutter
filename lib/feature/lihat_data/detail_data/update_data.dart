                    ...
                    child: Column(
                      ...
                      children: [
                        FormBuilderTextField(
                          name: 'nik',
                          readOnly: true,
                          initialValue: controller.dataArray[controller.index].nik,
                        ...
                        FormBuilderTextField(
                          name: 'nama',
                          initialValue: controller.dataArray[controller.index].name,
                          enabled: !controller.isLoading,
                          decoration: InputDecoration(
                        ...
                        FormBuilderTextField(
                          name: 'phone',
                          enabled: !controller.isLoading,
                          initialValue: controller.dataArray[controller.index].phone,
                          decoration: InputDecoration(
                        ...
                        FormBuilderDateTimePicker(
                          name: 'date',
                          initialValue: DateFormat('dd/MM/yyyy').parse(controller.dataArray[controller.index].date ?? ''),
                          enabled: !controller.isLoading,
                          decoration: InputDecoration(
                        ...
                        FormBuilderTextField(
                          name: 'address',
                          initialValue: controller.dataArray[controller.index].address,
                          enabled: !controller.isLoading,
                          decoration: InputDecoration(
